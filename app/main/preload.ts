...
contextBridge.exposeInMainWorld('weave', {
  ...
  ens: {
    getMemberRole: (args: object) => ipcRenderer.invoke('ens:getMemberRole', args),
    grantAdmin:    (args: object) => ipcRenderer.invoke('ens:grantAdmin', args),
    revokeAccess:  (args: object) => ipcRenderer.invoke('ens:revokeAccess', args),
    getTxt:          (args: object) => ipcRenderer.invoke('ens:getTxt', args),
    setTxt:          (args: object) => ipcRenderer.invoke('ens:setTxt', args),
    defineRole:      (args: object) => ipcRenderer.invoke('ens:defineRole', args),
    listOrgRoles:    (args: object) => ipcRenderer.invoke('ens:listOrgRoles', args),
    grantNamedRole:  (args: object) => ipcRenderer.invoke('ens:grantNamedRole', args),
    revokeNamedRole: (args: object) => ipcRenderer.invoke('ens:revokeNamedRole', args),
    setCapabilities: (args: object) => ipcRenderer.invoke('ens:setCapabilities', args),
    getCapabilities: (args: object) => ipcRenderer.invoke('ens:getCapabilities', args),
    setContentHash:  (args: object) => ipcRenderer.invoke('ens:setContentHash', args),
    setCoinAddr:     (args: object) => ipcRenderer.invoke('ens:setCoinAddr', args),
    addSubAdmin:     (args: object) => ipcRenderer.invoke('ens:addSubAdmin', args),
    removeSubAdmin:  (args: object) => ipcRenderer.invoke('ens:removeSubAdmin', args),
  },
